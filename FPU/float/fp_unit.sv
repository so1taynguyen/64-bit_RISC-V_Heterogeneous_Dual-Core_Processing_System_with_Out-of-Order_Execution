...
module fp_unit (
    ...
    fp_mac_in_type fp_div_mac_i;
    fp_mac_out_type fp_div_mac_o;
    fp_fdiv_in_type fp_fdiv_i;
    fp_fdiv_out_type fp_fdiv_o;

    fp_mac_in_type fp_sqrt_mac_i;
    fp_mac_out_type fp_sqrt_mac_o;
    fp_fdiv_in_type fp_fsqrt_i;
    fp_fdiv_out_type fp_fsqrt_o;
    ...
    fp_mac fp_div_mac_comp (
        .reset(reset),
        .clock(clock),
        .fp_mac_i(fp_div_mac_i),
        .fp_mac_o(fp_div_mac_o)
    );
    ...
    fp_mac fp_sqrt_mac_comp (
        .reset(reset),
        .clock(clock),
        .fp_mac_i(fp_sqrt_mac_i),
        .fp_mac_o(fp_sqrt_mac_o)
    );

    fp_fdiv fp_fsqrt_comp (
        .reset(reset),
        .clock(clock),
        .fp_fdiv_i(fp_fsqrt_i),
        .fp_fdiv_o(fp_fsqrt_o),
        .fp_mac_o(fp_sqrt_mac_o),
        .fp_mac_i(fp_sqrt_mac_i)
    );
    ...
    fp_exe fp_exe_comp (
        ...
        .fp_fdiv_o(fp_fdiv_o),
        .fp_fdiv_i(fp_fdiv_i),
        .fp_fsqrt_o(fp_fsqrt_o),
        .fp_fsqrt_i(fp_fsqrt_i),
        .fp_rnd_o(fp_rnd_o),
        .fp_rnd_i(fp_rnd_i)
    );
